...
def export_pdf(payload: ConfigPayload):
    ...
    try:
        ...
        # Header
        story.append(Paragraph("Shaadi.AI", title_style))
        ...
        story.append(Paragraph(
            f"Generated by Shaadi.AI | {datetime.now().strftime('%d %B %Y')} | AI Confidence: {confidence}",
            note_style))
        story.append(Paragraph(
        ...
        return Response(content=pdf_bytes, media_type="application/pdf",
            headers={"Content-Disposition": "attachment; filename=ShaadiBudget.pdf"})
        ...
        lines = ["SHAADI.AI — WEDDING BUDGET REPORT", "="*50,
        ...
        return Response(content="\n".join(lines), media_type="text/plain",
            headers={"Content-Disposition": "attachment; filename=ShaadiBudget.txt"})
